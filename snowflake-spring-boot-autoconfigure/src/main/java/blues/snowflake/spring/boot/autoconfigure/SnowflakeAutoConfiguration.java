package blues.snowflake.spring.boot.autoconfigure;

import blues.snowflake.spring.boot.autoconfigure.core.Snowflake;
import blues.snowflake.spring.boot.autoconfigure.core.SnowflakeProperties;
